...
struct CStaticFunction10 : public hx::Object 
{ 
   StaticFunction10 mFunction;
   const char *mName;

   HX_IS_INSTANCE_OF enum { _hx_ClassId = 254 }; // this is a hack! Lets see when this explodes :D


   CStaticFunction10(const char *inName,StaticFunction10 inFunction)
   {
      mName = inName;
      mFunction = inFunction;
   }
   int __Compare(const hx::Object *inRHS) const
   {
      const CStaticFunction10 *other = dynamic_cast<const CStaticFunction10 *>(inRHS);
      if (!other)
         return -1;
      return mName==other->mName && mFunction==other->mFunction && mName==other->mName ? 0 : -1;
   }
   ...
   Dynamic __Run(const Array<Dynamic> &inArgs) 
   { 
      return mFunction(inArgs[0],inArgs[1],inArgs[2],inArgs[3],inArgs[4],inArgs[5],inArgs[6],inArgs[7],inArgs[8],inArgs[9]);
   } 
   Dynamic __run(const Dynamic &inArg0,const Dynamic &inArg1,const Dynamic &inArg2,const Dynamic &inArg3,const Dynamic &inArg4,const Dynamic &inArg5, const Dynamic &inArg6, const Dynamic &inArg7, const Dynamic &inArg8, const Dynamic &inArg9) 
   { 
      return mFunction(inArg0,inArg1,inArg2,inArg3,inArg4,inArg5,inArg6,inArg7,inArg8,inArg9);
   } 
};


HXCPP_EXTERN_CLASS_ATTRIBUTES
Dynamic CreateStaticFunction10(const char *inName,StaticFunction10 inFunc)
   { return new CStaticFunction10(inName,inFunc); }
