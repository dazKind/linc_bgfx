...
extern class Native_DynamicIndexBufferHandle {
...
#if (scriptable || cppia)
    class CppiaDynamicIndexBufferHandle {
        public var __ptr:cpp.Pointer<Native_DynamicIndexBufferHandle> = null;
        public var __inst:Native_DynamicIndexBufferHandle = new Native_DynamicIndexBufferHandle();
        public function new() {}
    ...
    typedef DynamicIndexBufferHandle = CppiaDynamicIndexBufferHandle;
#else
